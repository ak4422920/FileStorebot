...
SHORTENER_PIC = os.environ.get("SHORTENER_PIC", "https://envs.sh/mcn.jpg")
#--------------------------------------------
...
UPI_ID = os.environ.get("UPI_ID", "send a message to the owner")
QR_PIC = os.environ.get("QR_PIC", "https://envs.sh/mjs.jpg")
